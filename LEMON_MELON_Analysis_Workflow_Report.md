...
## 27. Current Scientific Interpretation
...
## 28. Important Files and Outputs
...
### 28.7. Main Difference Waves

```text
reports/erp_diff/
```

### 28.8. Sensitivity Difference Waves
...
## 29. Key Decisions Made During the Process
...
11. The scientific narrative is now clear.

---

## 31. Logical Next Step
...
Then run subject-level statistical tests:
...
The current tables are mostly grand-average summaries. For the final Results section, we need to be able to say:

> At the subject level, the Face − Non-face W4 difference was consistently positive across participants in scalp and ear ROIs.

Or, if it does not survive correction:

> The effect showed a consistent positive trend but did not survive correction due to the limited sample size.

This step is essential for the final Results section.

---

## 32. Final Summary So Far
...
> Ear-EEG may preserve coarse face-related neural information, but it does not yet provide strong evidence for robust emotion-specific information in this paradigm.
