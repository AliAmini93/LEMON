...
- W4 scalp topography for the Face − Non-face effect
- Clean topography variants: no-Fp and robust-scale maps
- LaTeX-ready result text and captions

The current strongest finding is:

> **Face − Non-face differences are clear in scalp EEG and partially preserved in ear-EEG, especially in the strict-ear and right-ear ROIs. The strongest late effect occurs in W4 = 320–600 ms and decreases during W5 = 600–800 ms. Scalp topography supports a posterior-to-centroparietal W4 distribution, while frontal-pole channels show large opposite-polarity values and should be treated cautiously.**
...
| Scalp W4 topography, Face − Non-face | W4: 320–600 ms | posterior-to-centroparietal positivity; frontal-pole negativity handled with no-Fp/robust variants |
...
## 22A. Generate W4 Scalp Topography

After publication-ready ERP figures are regenerated, run the W4 scalp topography analysis. This is a supporting analysis for the main Face − Non-face result.
...
```text
[OK] Wrote subject-channel values: reports\topography\scalp_sens_face_vs_nonface_W4_subject_channel_values.csv
[OK] Wrote channel summary: reports\topography\scalp_sens_face_vs_nonface_W4_channel_values.csv
[OK] Wrote channel n-subjects: reports\topography\scalp_sens_face_vs_nonface_W4_channel_n_subjects.csv
[OK] Wrote skipped subjects: reports\topography\scalp_sens_face_vs_nonface_W4_skipped_subjects.csv
[OK] Wrote: reports\topography\scalp_sens_face_vs_nonface_W4_topomap.png
[OK] Wrote: reports\topography\scalp_sens_face_vs_nonface_W4_topomap.pdf
[OK] Wrote: reports\topography\README.md
```
...
> The W4 Face − Non-face scalp effect shows a posterior-to-centroparietal positive distribution. The strongest positive channels were O2, O1, P4, Pz, CP6, T7, T8, Cz, CP2, and CP1. Frontal-pole channels Fp1, Fpz, and Fp2 showed large opposite-polarity values and therefore require cautious interpretation.

---

## 22B. Generate Clean Topography Variants

Because the first all-channel topography was strongly influenced by frontal-pole channels, generate clean topography variants.
...
```text
[OK] Wrote: reports\topography_clean\scalp_sens_face_vs_nonface_W4_topomap_no_fp.png
[OK] Wrote: reports\topography_clean\scalp_sens_face_vs_nonface_W4_topomap_no_fp.pdf
[OK] Wrote: reports\topography_clean\scalp_sens_face_vs_nonface_W4_topomap_robust_scale.png
[OK] Wrote: reports\topography_clean\scalp_sens_face_vs_nonface_W4_topomap_robust_scale.pdf
[OK] Wrote: reports\topography_clean\scalp_sens_face_vs_nonface_W4_topomap_clean_panel.png
[OK] Wrote: reports\topography_clean\scalp_sens_face_vs_nonface_W4_topomap_clean_panel.pdf
[OK] Wrote: reports\topography_clean\scalp_sens_face_vs_nonface_W4_clean_topography_summary.csv
[OK] Wrote: reports\topography_clean\README.md
```
...
> Use the no-Fp topography as the main spatial visualization. Use the robust-scale or clean-panel version as transparency/supplementary material because it shows the frontal-pole issue rather than hiding it.
...
Also verify whether the scalp W4 topography remains broadly posterior-to-centroparietal after the new subjects are added. If frontal-pole channels remain extreme, keep the no-Fp topography as the main visualization and report the all-channel/robust map transparently.
...
- Does the W4 scalp topography still show posterior-to-centroparietal positivity?
- Are Fp1/Fpz/Fp2 still extreme enough to justify using the no-Fp map as the main visualization?
...
scalp_sens_face_vs_nonface_W4_topomap_no_fp.png
```
...
> The late Face − Non-face effect is strongest in W4 = 320–600 ms. This effect is robust in scalp late ROI, has posterior-to-centroparietal support in the clean scalp topography, and is also visible in ear-EEG, especially in strict-ear and right-ear ROIs. The effect decreases after 600 ms, with the clearest W4-to-W5 decrease observed in ear-EEG strict/right configurations.
...
- [ ] Generate W4 scalp topography
- [ ] Generate clean no-Fp/robust topography variants
...
## 34. Latest Update: Topography and Final Evidence Summary

This guide has now been updated to include the latest scalp topography analyses.

### 34.1. New scripts added

```text
scripts/03g_plot_w4_topography.py
scripts/03h_plot_clean_topography.py
```

### 34.2. New output folders added
...
### 34.3. Recommended topography figures
...
### 34.4. Current strongest reproducible findings

| Finding | Status |
|---|---|
| Scalp W4 Face − Non-face late ROI effect | strongest and most defensible |
...
| Emotional − Neutral | exploratory |
| Canonical N170 preservation | not strongly supported |

### 34.5. Current final interpretation

The current ERP-first analysis supports this cautious conclusion:

> The LEMON/MELON Emotional Affect paradigm shows robust late Face − Non-face ERP differentiation in scalp EEG, with posterior-to-centroparietal spatial support. Ear-EEG partially preserves this late face-related information, especially in strict-ear and right-ear configurations. Emotional − Neutral effects and canonical N170-like preservation remain weak or exploratory.

---

**Last updated:** 2026-04-29 16:00  
**Update note:** Added W4 scalp topography, clean topography variants, topography rerun commands, updated final output lists, troubleshooting for frontal-pole dominance, and an updated evidence summary.
